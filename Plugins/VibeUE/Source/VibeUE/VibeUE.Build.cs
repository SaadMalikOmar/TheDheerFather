...
public class VibeUE : ModuleRules
{
	public VibeUE(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// Local override: the MSVC 14.51 toolset raises new deprecation warnings inside
		// ENGINE headers this module includes — /WX turned those into hard errors (C2220).
